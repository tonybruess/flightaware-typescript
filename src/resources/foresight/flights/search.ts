...
export class Search extends APIResource {
   ...
   * parameters. If available, flights' predicted OOOI fields will be set.
   *
   * @example
   * ```ts
   * const response =
   *   await client.foresight.flights.search.advanced();
   * ```
   */
  advanced(
    query: SearchAdvancedParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<SearchAdvancedResponse> {
    return this._client.get('/foresight/flights/search/advanced', { query, ...options });
  }
}

export interface SearchAdvancedResponse {
  flights: Array<SearchAdvancedResponse.Flight>;

  /**
   * Object containing links to related resources.
   */
  links: SearchAdvancedResponse.Links | null;
...
export namespace SearchAdvancedResponse {
