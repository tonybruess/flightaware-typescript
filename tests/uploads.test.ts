import fs from 'fs';
import type { ResponseLike } from 'flightaware/internal/to-file';
import { toFile } from 'flightaware/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('flightaware/core/uploads');
    await expect(
